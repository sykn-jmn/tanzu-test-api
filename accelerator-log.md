...
```json
{
  "projectName" : "jeman-api",
  "repositoryPrefix" : "gitlab.orangeandbronze.com:5050/onb-way-project/tap/supply-chain"
}
```
## Log
```
...
┃ ┃ ┃ ┃ ┃ ┃ ┗  Info Will replace [tanzu-java-web-app->jeman-api]
...
┃ ┃ ┃ ┃ ┗ ┗ ┗  Info Will replace [your-registry.io/project->gitlab.orangeandbron...(truncated)]
